...
plt.title('New cases confirmed (China)', {'fontsize':10, 'color': '#222222'})
...
plt.title('New cases suspected (China)', color='#222222', fontsize=10)
...
host.set_title('New cases Confirmed+Suspected (China)', color='#222222', fontsize=10)
x = xhb.index.repeat(xhb['Confirmed']+xhb['Suspected'])
