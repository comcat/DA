...
par.bar(itn.index+w, itn.values, width=w, alpha=.98, color='#0b0c0c', label='Germany: '+it_start_day+'~'+it_end_day)
...
ofname = "export/ge-vs-hb-" + it_day_range[il-1].strftime('%m%d') + '.png'
