...
uk = pd.read_csv("./data/covid-19-who/us.csv", skipinitialspace=True, index_col='Date', parse_dates=True)
...
xlb = pd.date_range('2020-01-23', periods=l+10, freq='1d')
...
plt.title('New confirmed cases of United States', {'fontsize':12, 'color': '#222222'})
