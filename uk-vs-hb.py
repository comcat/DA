...
it = pd.read_csv("./data/covid-19-who/uk.csv", skipinitialspace=True, index_col='Date', parse_dates=True)
...
ofname = "export/uk-vs-hb-" + it_day_range[il-1].strftime('%m%d') + '.png'
