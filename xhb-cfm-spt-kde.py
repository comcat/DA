...
plt.title('New cases suspected (Outside Hubei)', color='#222222', fontsize=10)
...
host.set_title('New cases Confirmed+Suspected (Outside Hubei)', color='#222222', fontsize=10)
x = xhb.index.repeat(xhb['Confirmed']+xhb['Suspected'])
