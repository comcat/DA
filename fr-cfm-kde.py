...
uk = pd.read_csv("./data/covid-19-who/France.csv", skipinitialspace=True, index_col='Date', parse_dates=True)
...
xlb = pd.date_range('2020-01-26', periods=l+10, freq='1d')
...
plt.title('New confirmed cases of France', {'fontsize':10, 'color': '#222222'})
